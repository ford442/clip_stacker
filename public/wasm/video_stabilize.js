...
var R=a=>{for(;0<a.length;)a.shift()(b)},S={c:()=>{J("")},a:(a,c,d)=>A.copyWithin(a,c,c+d),b:a=>{var c=A.length;a>>>=0;if(134217728<a)return!1;for(var d=1;4>=d;d*=2){var e=c*(1+.2/d);e=Math.min(e,a+100663296);var h=Math;e=Math.max(a,e);a:{h=(h.min.call(h,134217728,e+(65536-e%65536)%65536)-y.buffer.byteLength+65535)/65536;try{y.grow(h);B();var O=1;break a}catch(X){}O=void 0}if(O)return!0}return!1}},T=function(){function a(d){T=d.exports;y=T.d;B();D.unshift(T.e);G--;b.monitorRunDependencies?.(G);0==
G&&(null!==H&&(clearInterval(H),H=null),I&&(d=I,I=null,d()));return T}var c={a:S};G++;b.monitorRunDependencies?.(G);if(b.instantiateWasm)try{return b.instantiateWasm(c,a)}catch(d){w(`Module.instantiateWasm callback failed with error: ${d}`),g(d)}L||=b.locateFile?K("video_stabilize.wasm")?"video_stabilize.wasm":b.locateFile?b.locateFile("video_stabilize.wasm",q):q+"video_stabilize.wasm":(new URL("video_stabilize.wasm",import.meta.url)).href;Q(c,function(d){a(d.instance)}).catch(g);return{}}();
b._stab_create=(a,c,d)=>(b._stab_create=T.f)(a,c,d);b._stab_push_frame=(a,c)=>(b._stab_push_frame=T.g)(a,c);b._stab_frame_count=a=>(b._stab_frame_count=T.h)(a);b._stab_finalize=a=>(b._stab_finalize=T.i)(a);b._stab_get_matrix=(a,c,d)=>(b._stab_get_matrix=T.j)(a,c,d);b._stab_get_zoom=a=>(b._stab_get_zoom=T.k)(a);b._stab_get_max_correction=a=>(b._stab_get_max_correction=T.l)(a);b._stab_apply_warp=(a,c,d,e)=>(b._stab_apply_warp=T.m)(a,c,d,e);b._stab_destroy=a=>(b._stab_destroy=T.n)(a);
b._malloc=a=>(b._malloc=T.o)(a);b._free=a=>(b._free=T.p)(a);var U;I=function V(){U||W();U||(I=V)};

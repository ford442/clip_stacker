...
from ltx_core.pipeline.components.protocols import SpatioTemporalScaleFactors, VideoLatentShape
...
class Decoder(nn.Module):
    ...
    def tiled_decode(
        ...
        total_number_of_chunks = len(temporal_groups)
        ...
        for temporal_group_tiles in temporal_groups:
            ...
            if previous_chunk is not None:
                ...
                yield (previous_chunk / previous_weights)[:, :, :yield_len, :, :], total_number_of_chunks
        ...
        if previous_chunk is not None:
            previous_weights = previous_weights.clamp(min=1e-8)
            yield previous_chunk / previous_weights, total_number_of_chunks
    ...
    def _accumulate_temporal_group_into_buffer(
        ...
        for tile in group_tiles:
            ...
            # LT_INTERNAL: useless, always zero!

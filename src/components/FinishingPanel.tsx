...
const STUB_PASSES: Array<{
  key: 'noiseReduction' | 'secondaryColor' | 'sharpen' | 'grain';
  label: string;
  description: string;
  ...
  return (
    <div className="finishing-panel">
      ...
      <p className="inspector-hint">
        ...
        {' — '}
        Primary color has best-effort FFmpeg parity; Canvas2D does not apply
        finishing.
      </p>

      {STUB_PASSES.filter((p) => p.key === 'noiseReduction').map(

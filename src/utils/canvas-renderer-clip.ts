/**
 * CanvasRenderer — browser-native compositing engine for rendering clips sequentially.
 *
...
import type { RendererOptions, RenderProgress, ProgressCallback } from "./canvas-renderer-types";
